...
\newcommand{\sep}{\textcolor{black!70}{/}\xspace}

% Ranking
\newcommand{\firstColor}{sns_violet!60}
\newcommand{\secondColor}{sns_yellow}
\newcommand{\firstB}[1]{\hspace{-0.7\fboxsep}\begingroup\setlength{\fboxsep}{0.06cm}\colorbox{\firstColor}{${#1}$}\endgroup\hspace{-0.7\fboxsep}}
\newcommand{\secondB}[1]{\hspace{-0.7\fboxsep}\begingroup\setlength{\fboxsep}{0.06cm}\colorbox{\secondColor}{${#1}$}\endgroup\hspace{-0.7\fboxsep}}
